...
SWING_FOOT_AIRBORNE_REWARD_WEIGHT = 2
TIME_OFF_GROUND_BASE_VALUE = 1
TIME_OFF_GROUND_GROWTH_RATE = 0.3
SWING_KNEE_FLEXION_SATURATION = math.radians(25.0)
SWING_KNEE_FLEXION_REWARD_WEIGHT = 1
LEG_ROLL_VELOCITY_THRESHOLD = math.radians(45.0)
...
COMMAND_ZERO_DEFAULT_JOINT_POSE_REWARD_STD_START = 350
...
class RewardsCfg:
    ...
    command_zero_default_joint_pose = RewTerm(
        ...
        params={
            ...
            "post_lift_delay_s": COMMAND_ZERO_DEFAULT_JOINT_POSE_POST_LIFT_DELAY_S,
            "command_name": ONE_FOOT_COMMAND_NAME,
            "asset_cfg": SceneEntityCfg(
                "robot", joint_names=LEG_JOINT_NAMES, preserve_order=True
            ),
