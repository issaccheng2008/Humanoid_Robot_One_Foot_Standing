...
SWING_KNEE_FLEXION_REWARD_WEIGHT = 0.0
LEG_ROLL_VELOCITY_THRESHOLD = math.radians(60.0)
LEG_ROLL_VELOCITY_PENALTY_WEIGHT = -0.5
LEG_OUTWARD_ROLL_THRESHOLD = math.radians(15.0)
