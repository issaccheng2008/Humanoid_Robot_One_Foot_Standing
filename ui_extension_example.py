...
def some_public_function(x: int):
    print("[Humanoid_Robot_One_Foot_Standing] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[Humanoid_Robot_One_Foot_Standing] startup")
    ...
    def on_shutdown(self):
        print("[Humanoid_Robot_One_Foot_Standing] shutdown")